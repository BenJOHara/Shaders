...
//	glm::vec3 lightPos = glm::vec3(0, 4, 4);
	...
	do {
		...
		GLuint HeightMapTextureID = glGetUniformLocation(programID, "HeightMapTextureSampler");
		...
		glUniform1i(GrassTextureID, 2);
		glActiveTexture(GL_TEXTURE3);
		glBindTexture(GL_TEXTURE_2D, RockTexture);
		glUniform1i(RockTextureID, 3);
		glActiveTexture(GL_TEXTURE4);
		glBindTexture(GL_TEXTURE_2D, SnowTexture);
		glUniform1i(SnowTextureID, 4);


		glActiveTexture(GL_TEXTURE5);
		glBindTexture(GL_TEXTURE_2D, GrassTextureS);
		glUniform1i(GrassSTextureID, 5);
		glActiveTexture(GL_TEXTURE6);
		glBindTexture(GL_TEXTURE_2D, RockTextureS);
		glUniform1i(RockSTextureID, 6);
		glActiveTexture(GL_TEXTURE7);
		glBindTexture(GL_TEXTURE_2D, SnowTextureS);
		glUniform1i(SnowSTextureID, 7);
		...
		GLuint Model3x3MatrixID = glGetUniformLocation(programID, "M3x3");
		...
		glUniformMatrix3fv(Model3x3MatrixID, 1, GL_FALSE, &Model3x3Matrix[0][0]);
